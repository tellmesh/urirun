...
# urirun | 268f 65608L | python:246,shell:10,javascript:4,go:3,rust:2,typescript:2,less:1 | 2026-06-26
# stats: 2839 func | 148 cls | 268 mod | CC̄=4.4 | critical:264 | cycles:0
# alerts[5]: CC test_dashboard_html_tracks_tabs_actions_and_chat_fullscreen=125; CC test_archive_scanned_document_writes_pdf_json_index_and_detects_duplicate=26; CC test_sync_documents_to_node_copies_pdfs_and_logs_chat=23; CC test_chat_ask_plans_document_sync_without_llm=22; CC archive_scanned_document=15
# hotspots[5]: create_handler fan=59; archive_scanned_document fan=39; summary fan=29; write_document_pdf fan=28; serve fan=28
# evolution: baseline
...
M[268]:
  ...
  adapters/python/tests/test_dashboard_api_characterizing.py,206
  adapters/python/tests/test_declarative.py,103
  adapters/python/tests/test_diagnostics.py,1572
  adapters/python/tests/test_discovery.py,127
  adapters/python/tests/test_dispatch_protocol.py,263
  ...
  adapters/python/tests/test_planfile_adapter.py,346
  adapters/python/tests/test_progress.py,120
  adapters/python/tests/test_proof_cache.py,156
  ...
  adapters/python/tests/test_reversible.py,516
  ...
  adapters/python/tests/test_uri_invoke_characterizing.py,219
  ...
  adapters/python/urirun/connectors/connector_contract.py,144
  ...
  adapters/python/urirun/host/artifacts_admin.py,493
  adapters/python/urirun/host/capability.py,161
  adapters/python/urirun/host/chat_orchestrator.py,865
  ...
  adapters/python/urirun/host/dispatch.py,56
  adapters/python/urirun/host/document_metadata.py,520
  adapters/python/urirun/host/document_sync.py,1413
  adapters/python/urirun/host/domain_monitor.py,488
  adapters/python/urirun/host/fs_transfer.py,365
  adapters/python/urirun/host/host_dashboard.py,1885
  adapters/python/urirun/host/host_db.py,528
  adapters/python/urirun/host/host_integrations.py,357
  adapters/python/urirun/host/html_templates.py,4908
  adapters/python/urirun/host/node_types.py,266
  adapters/python/urirun/host/object_registry.py,1147
  adapters/python/urirun/host/planfile_adapter.py,282
  adapters/python/urirun/host/routing.py,81
  adapters/python/urirun/host/scanner_bridge.py,1544
  adapters/python/urirun/host/scanner_net.py,141
  adapters/python/urirun/host/scanner_service.py,335
  ...
  adapters/python/urirun/host/twin_bridge.py,330
  ...
  adapters/python/urirun/node/event_schema.py,93
  adapters/python/urirun/node/flow.py,2177
  ...
  adapters/python/urirun/node/mesh.py,275
  adapters/python/urirun/node/node_cli.py,898
  adapters/python/urirun/node/paths.py,39
  adapters/python/urirun/node/recovery.py,373
  adapters/python/urirun/node/reversible.py,645
  adapters/python/urirun/node/routing.py,174
  adapters/python/urirun/node/server.py,1011
  adapters/python/urirun/node/task_cli.py,345
  adapters/python/urirun/node/transport.py,541
  adapters/python/urirun/node/twin_store.py,123
  ...
  adapters/python/urirun/runtime/v2_mcp.py,213
  adapters/python/urirun/runtime/v2_service.py,138
  ...
  tests/test_host_dashboard.py,3700
...
D:
  ...
  adapters/python/tests/test_flow.py:
    e: test_first_url_extracts_https,test_first_url_extracts_http,test_first_url_returns_none_when_absent,test_first_url_returns_first_only,test_nl_key_lowercases,test_nl_key_strips_diacritics,test_nl_key_collapses_whitespace,test_requested_folder_path_downloads,test_requested_folder_path_default,test_flow_intents_llm_no_model_returns_none,test_flow_intents_llm_exception_returns_none,test_flow_intents_llm_parses_response,test_flow_intents_default_when_no_llm,test_flow_intents_all_false_sets_processes,test_flow_intents_uses_llm_result,test_flow_intents_use_llm_false_skips_llm,test_heuristic_flow_use_llm_false_always_empty,test_uri_segments_basic,test_uri_segments_no_path,test_uri_matches_template_exact,test_uri_matches_template_with_param,test_uri_matches_template_different_scheme,test_uri_matches_template_different_length,test_uri_matches_template_multi_param,test_json_from_text_plain,test_json_from_text_fenced,test_json_from_text_embedded,test_json_from_text_invalid_raises,test_dig_path_nested_dict,test_dig_path_list_index,test_dig_path_missing_key_raises,test_resolve_step_payload_from_reference,test_resolve_step_payload_passthrough,test_resolve_step_payload_mixed,test_resolve_step_payload_none_safe,test_make_dispatch_uri_returns_callable,test_make_dispatch_uri_ok_result_returned_directly,test_make_dispatch_uri_not_found_attempts_inprocess,test_make_dispatch_uri_non_not_found_returned_directly,test_thin_driver_resolves_step_payload_from_prior_result
    ...
    test_heuristic_flow_use_llm_false_always_empty(monkeypatch)
  ...
  adapters/python/tests/test_host_routing.py:
    e: test_no_inputs_returns_empty,test_selected_nodes_deduped,test_node_targets_extracted_from_selected_targets,test_non_node_targets_ignored,test_explicit_nodes_plus_node_targets_merged_deduped,test_whitespace_stripped,_route,test_no_filters_accepts_all,test_route_matches_by_node_field,test_route_matches_by_uri_host,test_host_target_matches_host_uri,test_node_target_in_selected_targets,test_host_in_selected_targets,_routes,test_no_routes_returns_false,test_screen_uri_detected,test_kvm_uri_detected,test_screenshot_in_uri_detected,test_browser_capture_detected,test_unrelated_routes_return_false,test_node_filter_restricts_routes,test_no_gap_when_prompt_doesnt_need_capture,test_no_gap_when_capture_route_present,test_gap_returned_when_capture_missing,test_gap_includes_related_routes,test_gap_respects_selected_nodes
  ...
  adapters/python/tests/test_proof_cache.py:
    e: TestProofStore,_DurableEnv,TestProofDurable,TestProofCheckRecord,TestProofGate
    ...
    _DurableEnv: setUp(0),tearDown(0)  # Point durable_memory() at a throwaway JSON file for the dura
    TestProofDurable: test_proofs_namespace_persists_across_handles(0)
    TestProofCheckRecord: _pay(0),test_check_miss_then_record_then_hit(0),test_record_negative_is_no_op(0),test_route_key_matches_episode_proof_key(0)
    TestProofGate: _pay(0),test_new_env_probes_and_records(0),test_same_context_hits_and_skips_sandbox(0),test_drift_invalidates_and_reprobes(0),test_irreversible_blocks_and_caches_nothing(0)  # check → probe → record, with the sandbox probe patched.
  ...
  adapters/python/tests/test_reversible.py:
    e: KvmFake,DataFake,ReversibleEngineTests,FlowBridgeTests,TwinMemoryTests,NodelessInverseRebaseTests,PlannerContextTests,PlausibilityTests,NormalizeStuckTests
  ...
  adapters/python/urirun/host/artifacts_admin.py:
    e: artifact_delete_roots,artifact_file_delete_allowed,payload_bool,global_document_metadata_paths,safe_artifact_sidecar_path,artifact_delete_candidate_paths,delete_one_artifact_file,delete_artifact_files,artifact_visual_path,artifact_file_exists,artifact_dedupe_key,artifact_dedupe_rank,merge_artifact_group,preview_url,public_artifact,public_artifacts,attachment_visual_path,apply_attachment_file_fields,apply_attachment_visual_fields,public_chat_attachment,public_chat_attachments,dedupe_public_artifacts,visible_public_artifacts,collect_attachments,iter_orphan_candidates,cleanup_one_sidecar,artifacts_delete,artifacts_dedupe_rows,artifacts_cleanup_orphan_sidecars
    artifact_delete_roots(project)
    artifact_file_delete_allowed(path;project)
    payload_bool(payload;name;default)
    global_document_metadata_paths()
    safe_artifact_sidecar_path(path;project)
    artifact_delete_candidate_paths(item;project)
    delete_one_artifact_file(artifact_path;role;project)
    delete_artifact_files(artifacts;project)
    artifact_visual_path(artifact)
    artifact_file_exists(path)
    artifact_dedupe_key(item)
    artifact_dedupe_rank(item)
    merge_artifact_group(group)
    preview_url(path;project)
    public_artifact(artifact;project)
    public_artifacts(artifacts;project)
    attachment_visual_path(meta)
    apply_attachment_file_fields(item;path;file_preview)
    apply_attachment_visual_fields(item;visual_path;visual_preview)
    public_chat_attachment(attachment;project)
    public_chat_attachments(attachments;project)
    dedupe_public_artifacts(public)
    visible_public_artifacts(artifacts;project)
    collect_attachments(value;project)
    iter_orphan_candidates(roots;seen;global_metadata)
    cleanup_one_sidecar(target;project)
    artifacts_delete(host_db;project;db;payload)
    artifacts_dedupe_rows(host_db;project;db;payload)
    artifacts_cleanup_orphan_sidecars(host_db;project;db;payload)
  ...
  adapters/python/urirun/host/chat_orchestrator.py:
    ...
    _chat_ask_general_check_offline(selected_nodes;discovered;db;prompt;execute;selected_targets;deps)
    _chat_ask_general_build_result(execution;flow;discovered;generator;selected_nodes;selected_targets;prompt;execute;payload;project;db;deps)
  ...
  adapters/python/urirun/host/connector_admin.py:
    e: connector_pip_tail,refresh_connector_schemes,env_check_error,docker_install_target,run_docker_check,parse_bindings_output,connector_env_check,_connector_install_node,connector_install
  ...
  adapters/python/urirun/host/dashboard_api.py:
    e: _first,_host_db,_mesh,_planfile_adapter,_host_config,_safe_tickets,_task_counts,_lan_qr_profile,chat_history,_api_summary,_api_objects,_api_node_types,_api_tasks,_api_checks,_api_logs,_api_artifacts,_api_chat_history,_api_services_live,_api_scanner_live,_api_nodes_or_routes,_api_twin_flows,_api_twin_state,_dashboard_api_response,chat_delete_messages,task_create
  ...
  adapters/python/urirun/host/dispatch.py:
    e: inprocess_fallback,make_local_dispatch_uri
  ...
  adapters/python/urirun/host/document_sync.py:
    e: document_archive_root,document_index_path,document_sync_default_dest_root,document_sync_default_node,archive_month,pdf_text,pdf_stream,document_files_exist,filename_part,canonical_document_filename,document_filename_with_id,artifact_schema_known,document_schema_fields,needs_screen_document_capture,truthy_env,document_sync_auto_retry_enabled,_urifix_auto_retry,_validated_sync_retry_payload,document_sync_retry_payload_from_urifix,document_sync_dest_from_prompt,boolish,document_archive_pdfs,document_sync_verification,_log_and_chat_report,_resolve_node_params,_parse_sync_params,_build_sync_params,_check_preflight,_upload_file,_read_back_file,sync_documents_to_node,scanned_id_log_path,load_document_index,save_document_index,prune_orphaned_documents,iter_scanned_id_log,append_scanned_id_log,existing_scanned_id,scanned_log_entry,scanned_entry_seen,scanned_seen_buckets,backfill_scanned_id_log,write_document_pdf,sidecar_text,unique_document_path,existing_document,existing_document_meta,is_blank_metadata,merge_metadata_fields,enrich_archived_record,file_sha256,docid_for_file,find_duplicate_document,metadata_completeness,_cleanup_scan_files_lazy,archive_redundant_duplicate,supersede_archived_document,archive_scanned_document,reconcile_document_index,DocumentSyncDeps,_SyncParams
    DocumentSyncDeps:
    _SyncParams:
    ...
    prune_orphaned_documents(index)
    iter_scanned_id_log()
    append_scanned_id_log(entry)
    existing_scanned_id()
    scanned_log_entry(item)
    scanned_entry_seen(entry;seen)
    scanned_seen_buckets(existing)
    backfill_scanned_id_log(index)
    write_document_pdf(image_path;pdf_path)
    sidecar_text(item)
    unique_document_path(directory;filename;doc_id)
    existing_document(index)
    existing_document_meta(duplicate)
    is_blank_metadata(value)
    merge_metadata_fields(old_meta;new_meta)
    enrich_archived_record(existing;fused;enriched_fields)
    file_sha256(path)
    docid_for_file(path;ocr_text)
    find_duplicate_document(index)
    metadata_completeness(meta)
    _cleanup_scan_files_lazy(paths)
    archive_redundant_duplicate()
    supersede_archived_document()
    archive_scanned_document()
  ...
  adapters/python/urirun/host/host_dashboard.py:
    e: _prune_scanner_staging,_archive_scanned_document,artifacts_delete,artifacts_dedupe_rows,artifacts_cleanup_orphan_sidecars,_json_response,_html_response,_docs_nodes_html,_asset_response,_service_view_from_query,_service_widget_html,_service_widget_svg,_js_sdk_response,_read_json,_file_response,_chat_message,_add_chat_message,_sync_document_metadata_hooks,_extract_document_metadata,_local_image_ocr,_utc_now,_node_alias_map_from_context,_node_url_from_config,node_test_routes,_ensure_node_uri_routes,_document_sync_deps,sync_documents_to_node,startup_phone_qr,ensure_phone_scanner_service,_latest_scanner_page_status,_recent_scanner_artifacts,service_live_views,_scanner_bridge_deps,uri_event,_register_scanner_result,scanner_capture,scanner_best_finish,page_action_enqueue,_uri_action_lookup,_uri_mode,_service_restart_argv,restart_chat_service,restart_phone_scanner_service,_uri_simulated_result,_result_artifact_class,register_tagged_artifact,_run_inprocess_connector_uri,_svc_port,_svc_is_map,_svc_start_fn,_svc_restart_fn,_service_lifecycle_dispatch,_uri_invoke_route,_uri_invoke_page_action,_finalize_uri_result,_uri_invoke_fallback,uri_invoke,_service_contacts,summary,node_add,node_remove,configured_node_api_request,restart_android_node_service,_merge_live_webpage_nodes,phone_node_qr,_node_envelope_error,_probe_node_token,node_set_token,chat_ask,task_action,connector_test,documents_reconcile,_handle_events_sse,create_handler,_free_port_from_matching_processes,_is_dashboard_process,_free_port_from_old_dashboard,_free_port_from_old_scanner,_free_port_from_old_chat,_free_port_from_old_android_node,serve,command,default_host
  ...
  adapters/python/urirun/host/html_templates.py:
    e: docs_nodes_html,service_widget_html,service_widget_svg
    docs_nodes_html(profiles)
    service_widget_html(view)
    service_widget_svg(view;summary;width;height)
  ...
  adapters/python/urirun/host/object_registry.py:
    e: host_registry_routes,host_object,_uri_target,_route_core_fields,route_owner_route,dedupe_routes,_node_owner_dict,_node_own_routes,node_object,service_object,uri_objects,phone_scanner_contact,service_contacts,annotate_node_tokens,mirror_node_to_nodes_file,node_api_slug,node_api_secret_ref,store_node_api_secret,extract_raw_secret,extract_secret_ref,build_auth_extra_fields,normalize_node_api_auth,default_api_items,api_item_fields,normalize_api_item,normalize_node_apis,derive_node_capabilities,build_node_entry,persist_node_to_config,node_remove_from_mirror,node_kinds_path,node_kinds,set_node_kind,node_remove_kind,annotate_node_kinds,configured_node_api_parts,configured_node_api_lookup,configured_api_secret,apply_auth_header,configured_api_headers,join_api_url,configured_api_response_body,build_request_body,execute_http_request,resolve_http_method_and_url,connector_hint,connector_required_response,configured_api_call,apply_uri_overrides,resolve_node_api_identifiers,uri_action_catalog,_node_add_parse_payload,node_add,node_remove,node_envelope_error,probe_node_token,node_set_token
  ...
  adapters/python/urirun/host/routing.py:
    e: selected_nodes_from_targets,route_in_selected_targets,has_screen_capture_route,screen_document_capability_gap
  ...
  adapters/python/urirun/host/scanner_bridge.py:
    ...
    capture_reject_result()
    capture_candidate_result(project;payload)
    ...
    scanner_crop_overlay(original_path;crop;quality)
    auto_crop_receipt(path)
    capture_ocr_and_detect(path;display_path;payload;archive)
    refresh_best_ocr(fallback_ocr;original_path;display_path)
    ensure_best_overlay(best;crop;quality;original_path)
    scanner_capture(project;db;payload)
    scanner_best_finish(project;db;payload)
    staging_keep_paths()
    prune_scanner_staging(staging_dir_fn)
  ...
  adapters/python/urirun/host/scanner_service.py:
    e: phone_scanner_service_id,startup_phone_qr,phone_node_qr,ensure_phone_scanner_service,restart_phone_scanner_service
    phone_scanner_service_id(bind_host;port)
    startup_phone_qr(project;db)
    phone_node_qr(project;db;payload)
    ensure_phone_scanner_service(project;db;config;node_urls;token;identity)
    restart_phone_scanner_service(project;db;config;node_urls;token;identity;payload)
  ...
  adapters/python/urirun/host/twin_bridge.py:
    e: flow_has_desktop_step,_step_inverse,_is_infra_step,_step_info_from_results,_inverse_from_results,_step_status,_step_narration,_publish_step_event,append_twin_widget,twin_plan_preview,twin_plan_summary,is_desktop_task_prompt,api_twin_state
    ...
    _publish_step_event(step;node;connector_inverse;degraded;degraded_reason;episode_id;experience_id;intent_sig)
  ...
  adapters/python/urirun/node/diagnostics.py:
    e: _target,_target_of,_is_login_surface,_build,diagnose,_match_rule,_surface_upgrade,_cdp_feasible,_controllable,_mark_feasibility,_os_level_unreliable,_maybe_escalate_surface,fit_to_environment,_uri_classify,_Rule
  ...
  adapters/python/urirun/node/event_schema.py:
    e: step_category,_StepTransition,StepEvent,FlowCompletedEvent
    _StepTransition:
  ...
  adapters/python/urirun/node/flow.py:
    e: _next_kind,_extract_inverse,_resolve_inverse_uri,_thin_circuit_break,_thin_rollback,_thin_handle_non_continue,_thin_update_ledger,_thin_step_entry,_thin_fold_inner_ok,_thin_goal_verify,_thin_driver,_flow_format,flow_document,write_flow_document,load_flow_document,first_url,nl_key,append_if_available,requested_folder_path,_flow_intents_llm,_flow_intents,_append_target_steps,heuristic_flow,json_from_text,_uri_segments,_uri_matches_template,_uri_is_available,_infeasibility_error,_step_is_infeasible,_normalize_flow_step,_normalize_flow_task,_needs_session_ready_after_ensure,_inject_cdp_ready_probes,_collect_infeasible_constraints,normalize_flow,normalize_flow_or_explain,llm_flow,_build_session_map,_append_session_guidance,fetch_planner_environments,make_flow,_dig_path,resolve_step_payload,_action_ok,_action_error,_flow_step_failure,_flow_timeline_entry,_fetch_kvm_query,_fetch_env_profile,_fetch_surface,_evaluate_step_next,_run_step,_self_heal_via_uri,_attempt_self_heal,_circuit_break,_preflight,_rollback_partial,_kvm_targets,suggest_recall,_flow_key,_remember_known_good_flow,_capture_known_good,_update_known_good,_drift_timeline,_circuit_break_if_over,_resolve_payload_or_fail,_step_fail_envelope,_abort_envelope,_set_service_map,_restore_service_map,_orchestrate_steps,_make_memory_dispatch,_plan_with_preflight,_build_thin_plan,execute_flow,_flow_stdout,_run_goal_check,_dig_value,_goal_passed,_verify_log_fragment_check,_verify_goal_check,verify_flow_execution,_apply_reversibility,run_flow_document,_in_process_discovery,make_dispatch_uri,_flow_transport,rollback_flow,_uri_goal_verify,_uri_preflight,_uri_env_drift,_uri_memory_remember,_proof_scenario_sig,_proof_key_for,_proof_probe,_proof_env_fp,_uri_proof_check,_uri_proof_record,_uri_proof_gate,FlowEnvelope
    ...
    _thin_fold_inner_ok(r)
    _thin_goal_verify(dispatch_uri;envelope;timeline;results)
    ...
    _flow_intents_llm(prompt)
    _flow_intents(prompt)
    ...
    _infeasibility_error(uri;c)
    _step_is_infeasible(uri;infeasible_constraints)
    _normalize_flow_step(step;index;allowed_uris;used;routes;infeasible_constraints)
    ...
    _collect_infeasible_constraints(environments)
    normalize_flow(flow;allowed_uris;routes;infeasible_constraints)
    normalize_flow_or_explain(flow;allowed_uris)
    llm_flow(prompt;routes;nodes;environments)
    _build_session_map(browser_sessions)
    ...
    _evaluate_step_next(step;entry;routes;execute;attempt;max_retries;healed;dispatch_uri)
    _run_step(step;payload;registry;execute;routes;recover;max_retries;dispatch_uri)
    _self_heal_via_uri(step;entry;routes;env_profile;surface;registry;dispatch_uri;diagnosis)
    ...
    _abort_envelope(step;step_timeline;step_recoveries;timeline;results;recoveries;registry;rollback_on_failure;execute;dispatch_uri)
    _set_service_map(mesh)
    _restore_service_map(old)
    _orchestrate_steps(flow;registry;execute;recover;max_retries;max_wall_clock;max_remediations;rollback_on_failure;memory;dispatch_uri;routes;timeline;results;recoveries)
    _make_memory_dispatch(base_dispatch;memory;flow;registry)
    _plan_with_preflight(steps)
    _build_thin_plan(steps;flow)
    ...
    _apply_reversibility(result;execution;ok;execute;rollback_on_failure;document;mesh;dispatch_uri)
    run_flow_document(document;mesh)
    _in_process_discovery(uri;payload)
    make_dispatch_uri(registry;mode)
    _flow_transport(mesh)
    rollback_flow(execution;mesh)
    _uri_goal_verify(payload)
    _uri_preflight(payload)
    _uri_env_drift(payload)
    _uri_memory_remember(payload)
    _proof_scenario_sig(uri;given)
    _proof_key_for(uri;env_fingerprint;scenario_sig)
    _proof_probe(uri;node;registry)
    _proof_env_fp(payload)
    _uri_proof_check(payload)
    _uri_proof_record(payload)
    _uri_proof_gate(payload)
  ...
  adapters/python/urirun/node/recovery.py:
    ...
    planner_failure(exc)
    _uri_remediate(payload)
  adapters/python/urirun/node/reversible.py:
    e: parse,path_of,sig,_step_kind,environment_fingerprint,plausibility,_planner_facts,_best_surface_hint,_action_matrix_hints,_infeasible_constraints,_planner_surface_guidance,planner_context,local_transport,durable_memory,rollback_partial_flow,_inner_value,_inverse_uri,ledger_from_execution,_transition_inverse_uri,_normalize_stuck,_uri_rollback,CallSpec,Action,Transition,Transport,CallableTransport,Connector,Twin,ReversibleProcess,TwinMemory
    ...
    TwinMemory: remember(2),known_good(1),drift(2),remember_flow(2),recall_flow(1),known_good_flows(0),remember_episode(1),known_good_episodes(0),recall_episode(2),remember_proof(2),recall_proof(1)  # Remembers the KNOWN-GOOD environment fingerprint per node (s
    parse(uri)
    path_of(uri)
    sig(obj)
    _step_kind(spec)
  ...
  adapters/python/urirun/runtime/v2_service.py:
    e: service_base,_post,call,make_dispatch
...
% ── Project Metadata ─────────────────────────────────────
project_metadata('urirun', '0.4.167', 'javascript').
...
project_file('adapters/python/tests/test_dashboard_api_characterizing.py', 206, 'python').
...
project_file('adapters/python/tests/test_dispatch_protocol.py', 263, 'python').
...
project_file('adapters/python/tests/test_planfile_adapter.py', 346, 'python').
project_file('adapters/python/tests/test_progress.py', 120, 'python').
project_file('adapters/python/tests/test_proof_cache.py', 156, 'python').
...
project_file('adapters/python/tests/test_reversible.py', 516, 'python').
...
project_file('adapters/python/tests/test_uri_invoke_characterizing.py', 219, 'python').
...
project_file('adapters/python/urirun/host/chat_orchestrator.py', 865, 'python').
...
project_file('adapters/python/urirun/host/document_sync.py', 1413, 'python').
...
project_file('adapters/python/urirun/host/host_dashboard.py', 1885, 'python').
...
project_file('adapters/python/urirun/host/object_registry.py', 1147, 'python').
...
project_file('adapters/python/urirun/host/scanner_bridge.py', 1544, 'python').
project_file('adapters/python/urirun/host/scanner_net.py', 141, 'python').
project_file('adapters/python/urirun/host/scanner_service.py', 335, 'python').
...
project_file('adapters/python/urirun/host/twin_bridge.py', 330, 'python').
...
project_file('adapters/python/urirun/node/flow.py', 2177, 'python').
...
project_file('adapters/python/urirun/node/mesh.py', 275, 'python').
project_file('adapters/python/urirun/node/node_cli.py', 898, 'python').
project_file('adapters/python/urirun/node/paths.py', 39, 'python').
project_file('adapters/python/urirun/node/recovery.py', 373, 'python').
project_file('adapters/python/urirun/node/reversible.py', 645, 'python').
project_file('adapters/python/urirun/node/routing.py', 174, 'python').
project_file('adapters/python/urirun/node/server.py', 1011, 'python').
project_file('adapters/python/urirun/node/task_cli.py', 345, 'python').
project_file('adapters/python/urirun/node/transport.py', 541, 'python').
project_file('adapters/python/urirun/node/twin_store.py', 123, 'python').
...
project_file('adapters/python/urirun/runtime/v2_mcp.py', 213, 'python').
project_file('adapters/python/urirun/runtime/v2_service.py', 138, 'python').
...
project_file('tests/test_host_dashboard.py', 3700, 'python').
...
python_function('adapters/python/tests/test_dashboard_api_characterizing.py', 'test_api_twin_state_shape', 1, 8, 4).
...
python_function('adapters/python/tests/test_flow.py', 'test_flow_intents_default_when_no_llm', 1, 3, 4).
...
python_function('adapters/python/tests/test_flow.py', 'test_flow_intents_use_llm_false_skips_llm', 1, 3, 7).
python_function('adapters/python/tests/test_flow.py', 'test_heuristic_flow_use_llm_false_always_empty', 1, 3, 5).
...
python_function('adapters/python/tests/test_host_routing.py', 'test_no_gap_when_prompt_doesnt_need_capture', 0, 4, 1).
python_function('adapters/python/tests/test_host_routing.py', 'test_no_gap_when_capture_route_present', 0, 2, 1).
python_function('adapters/python/tests/test_host_routing.py', 'test_gap_returned_when_capture_missing', 0, 5, 2).
...
python_function('adapters/python/urirun/host/chat_orchestrator.py', '_general_path_complete', 10, 12, 7).
...
python_function('adapters/python/urirun/host/chat_orchestrator.py', '_fetch_planner_environments_for_nodes', 5, 9, 2).
python_function('adapters/python/urirun/host/chat_orchestrator.py', '_chat_ask_general_check_offline', 7, 9, 4).
python_function('adapters/python/urirun/host/chat_orchestrator.py', '_chat_ask_general_build_result', 12, 9, 10).
python_function('adapters/python/urirun/host/chat_orchestrator.py', '_chat_ask_general', 13, 11, 19).
...
python_function('adapters/python/urirun/host/chat_orchestrator.py', 'chat_ask', 8, 14, 14).
...
python_function('adapters/python/urirun/host/connector_admin.py', 'connector_env_check', 1, 14, 11).
...
python_function('adapters/python/urirun/host/fs_transfer.py', 'run_node_uri', 3, 2, 3).
...
python_function('adapters/python/urirun/host/host_dashboard.py', '_service_widget_html', 2, 1, 2).
python_function('adapters/python/urirun/host/host_dashboard.py', '_service_widget_svg', 2, 3, 7).
...
python_function('adapters/python/urirun/host/host_dashboard.py', '_file_response', 3, 8, 18).
...
python_function('adapters/python/urirun/host/host_dashboard.py', 'summary', 4, 6, 29).
...
python_function('adapters/python/urirun/host/host_dashboard.py', 'configured_node_api_request', 3, 13, 9).
...
python_function('adapters/python/urirun/host/html_templates.py', 'service_widget_html', 1, 6, 5).
python_function('adapters/python/urirun/host/html_templates.py', 'service_widget_svg', 4, 5, 3).
...
python_function('adapters/python/urirun/host/object_registry.py', 'configured_api_secret', 1, 5, 3).
python_function('adapters/python/urirun/host/object_registry.py', 'apply_auth_header', 4, 10, 6).
python_function('adapters/python/urirun/host/object_registry.py', 'configured_api_headers', 2, 13, 9).
python_function('adapters/python/urirun/host/object_registry.py', 'join_api_url', 3, 8, 11).
python_function('adapters/python/urirun/host/object_registry.py', 'configured_api_response_body', 2, 4, 3).
python_function('adapters/python/urirun/host/object_registry.py', 'build_request_body', 2, 4, 6).
python_function('adapters/python/urirun/host/object_registry.py', 'execute_http_request', 7, 3, 6).
python_function('adapters/python/urirun/host/object_registry.py', 'resolve_http_method_and_url', 3, 10, 5).
python_function('adapters/python/urirun/host/object_registry.py', 'connector_hint', 1, 3, 1).
python_function('adapters/python/urirun/host/object_registry.py', 'connector_required_response', 3, 1, 1).
python_function('adapters/python/urirun/host/object_registry.py', 'configured_api_call', 3, 9, 11).
...
python_function('adapters/python/urirun/host/twin_bridge.py', '_step_inverse', 1, 15, 1).
...
python_function('adapters/python/urirun/host/twin_bridge.py', '_publish_step_event', 8, 7, 8).
python_function('adapters/python/urirun/host/twin_bridge.py', 'append_twin_widget', 12, 14, 10).
...
python_function('adapters/python/urirun/host/twin_bridge.py', 'api_twin_state', 5, 8, 9).
...
python_function('adapters/python/urirun/node/diagnostics.py', '_uri_classify', 1, 4, 3).
...
python_function('adapters/python/urirun/node/episode.py', '_sha1', 3, 2, 3).
python_function('adapters/python/urirun/node/episode.py', 'episode_id', 3, 1, 1).
python_function('adapters/python/urirun/node/episode.py', 'proof_key', 3, 1, 1).
python_function('adapters/python/urirun/node/episode.py', 'intent_signature', 1, 1, 4).
python_function('adapters/python/urirun/node/episode.py', '_reality_from_dict', 1, 3, 2).
...
python_function('adapters/python/urirun/node/flow.py', '_next_kind', 1, 4, 1).
python_function('adapters/python/urirun/node/flow.py', '_extract_inverse', 1, 6, 2).
python_function('adapters/python/urirun/node/flow.py', '_resolve_inverse_uri', 2, 4, 4).
python_function('adapters/python/urirun/node/flow.py', '_thin_circuit_break', 7, 4, 2).
python_function('adapters/python/urirun/node/flow.py', '_thin_rollback', 7, 10, 6).
python_function('adapters/python/urirun/node/flow.py', '_thin_handle_non_continue', 10, 7, 9).
python_function('adapters/python/urirun/node/flow.py', '_thin_update_ledger', 3, 7, 5).
python_function('adapters/python/urirun/node/flow.py', '_thin_step_entry', 3, 4, 2).
python_function('adapters/python/urirun/node/flow.py', '_thin_fold_inner_ok', 1, 4, 3).
python_function('adapters/python/urirun/node/flow.py', '_thin_goal_verify', 4, 6, 5).
python_function('adapters/python/urirun/node/flow.py', '_thin_driver', 5, 15, 15).
...
python_function('adapters/python/urirun/node/flow.py', '_flow_intents_llm', 1, 6, 7).
python_function('adapters/python/urirun/node/flow.py', '_flow_intents', 1, 6, 3).
...
python_function('adapters/python/urirun/node/flow.py', '_infeasibility_error', 2, 1, 0).
python_function('adapters/python/urirun/node/flow.py', '_step_is_infeasible', 2, 6, 1).
python_function('adapters/python/urirun/node/flow.py', '_normalize_flow_step', 6, 15, 11).
...
python_function('adapters/python/urirun/node/flow.py', '_collect_infeasible_constraints', 1, 6, 2).
python_function('adapters/python/urirun/node/flow.py', 'normalize_flow', 4, 5, 8).
python_function('adapters/python/urirun/node/flow.py', 'normalize_flow_or_explain', 2, 11, 8).
python_function('adapters/python/urirun/node/flow.py', 'llm_flow', 4, 8, 7).
python_function('adapters/python/urirun/node/flow.py', '_build_session_map', 1, 6, 2).
python_function('adapters/python/urirun/node/flow.py', '_append_session_guidance', 2, 7, 3).
python_function('adapters/python/urirun/node/flow.py', 'fetch_planner_environments', 3, 11, 9).
...
python_function('adapters/python/urirun/node/flow.py', '_evaluate_step_next', 8, 13, 5).
python_function('adapters/python/urirun/node/flow.py', '_run_step', 8, 10, 8).
python_function('adapters/python/urirun/node/flow.py', '_self_heal_via_uri', 8, 9, 4).
python_function('adapters/python/urirun/node/flow.py', '_attempt_self_heal', 4, 8, 9).
...
python_function('adapters/python/urirun/node/flow.py', '_abort_envelope', 10, 14, 10).
python_function('adapters/python/urirun/node/flow.py', '_set_service_map', 1, 2, 2).
python_function('adapters/python/urirun/node/flow.py', '_restore_service_map', 1, 2, 1).
python_function('adapters/python/urirun/node/flow.py', '_orchestrate_steps', 14, 12, 13).
python_function('adapters/python/urirun/node/flow.py', '_make_memory_dispatch', 4, 1, 12).
python_function('adapters/python/urirun/node/flow.py', '_plan_with_preflight', 1, 5, 3).
python_function('adapters/python/urirun/node/flow.py', '_build_thin_plan', 2, 12, 7).
...
python_function('adapters/python/urirun/node/flow.py', '_apply_reversibility', 8, 11, 6).
python_function('adapters/python/urirun/node/flow.py', 'run_flow_document', 2, 9, 10).
python_function('adapters/python/urirun/node/flow.py', '_in_process_discovery', 2, 9, 6).
python_function('adapters/python/urirun/node/flow.py', 'make_dispatch_uri', 2, 1, 1).
...
python_function('adapters/python/urirun/node/flow.py', '_uri_goal_verify', 1, 8, 5).
python_function('adapters/python/urirun/node/flow.py', '_uri_preflight', 1, 5, 6).
python_function('adapters/python/urirun/node/flow.py', '_uri_env_drift', 1, 10, 9).
python_function('adapters/python/urirun/node/flow.py', '_uri_memory_remember', 1, 13, 10).
python_function('adapters/python/urirun/node/flow.py', '_proof_scenario_sig', 2, 4, 6).
python_function('adapters/python/urirun/node/flow.py', '_proof_key_for', 3, 1, 2).
python_function('adapters/python/urirun/node/flow.py', '_proof_probe', 3, 3, 2).
python_function('adapters/python/urirun/node/flow.py', '_proof_env_fp', 1, 3, 1).
python_function('adapters/python/urirun/node/flow.py', '_uri_proof_check', 1, 4, 6).
python_function('adapters/python/urirun/node/flow.py', '_uri_proof_record', 1, 3, 7).
python_function('adapters/python/urirun/node/flow.py', '_uri_proof_gate', 1, 8, 11).
...
python_function('adapters/python/urirun/node/manage.py', '_project_name_from_dir', 1, 4, 8).
python_function('adapters/python/urirun/node/manage.py', '_project_root', 1, 6, 8).
python_function('adapters/python/urirun/node/manage.py', 'connector_install', 0, 13, 11).
...
python_function('adapters/python/urirun/node/manage.py', '_session_type', 0, 10, 5).
python_function('adapters/python/urirun/node/manage.py', '_compositor', 0, 9, 10).
python_function('adapters/python/urirun/node/manage.py', '_gpu_info', 0, 9, 7).
python_function('adapters/python/urirun/node/manage.py', '_resolution_info', 0, 4, 4).
python_function('adapters/python/urirun/node/manage.py', '_app_count', 0, 5, 4).
python_function('adapters/python/urirun/node/manage.py', 'host_facts', 0, 4, 10).
python_function('adapters/python/urirun/node/manage.py', 'bindings', 1, 2, 0).
python_function('adapters/python/urirun/node/node_cli.py', '_data_bindings', 2, 2, 4).
python_function('adapters/python/urirun/node/node_cli.py', '_data_init', 2, 1, 2).
python_function('adapters/python/urirun/node/node_cli.py', '_data_dataset_create', 2, 2, 3).
python_function('adapters/python/urirun/node/node_cli.py', '_data_datasets', 2, 1, 2).
python_function('adapters/python/urirun/node/node_cli.py', '_data_record_upsert', 2, 1, 3).
python_function('adapters/python/urirun/node/node_cli.py', '_data_records', 2, 2, 2).
python_function('adapters/python/urirun/node/node_cli.py', '_data_artifact_register', 2, 1, 3).
python_function('adapters/python/urirun/node/node_cli.py', '_data_artifacts', 2, 1, 2).
python_function('adapters/python/urirun/node/node_cli.py', '_data_check_add', 2, 1, 3).
python_function('adapters/python/urirun/node/node_cli.py', '_data_checks', 2, 1, 2).
python_function('adapters/python/urirun/node/node_cli.py', '_data_sql', 2, 1, 3).
python_function('adapters/python/urirun/node/node_cli.py', 'data_command', 1, 2, 2).
python_function('adapters/python/urirun/node/node_cli.py', 'monitor_command', 1, 14, 10).
python_function('adapters/python/urirun/node/node_cli.py', '_parse_api_json_args', 1, 5, 5).
python_function('adapters/python/urirun/node/node_cli.py', '_build_implicit_api', 1, 10, 0).
python_function('adapters/python/urirun/node/node_cli.py', '_handle_add_node_advanced', 1, 5, 7).
python_function('adapters/python/urirun/node/node_cli.py', '_handle_add_node', 1, 2, 5).
python_function('adapters/python/urirun/node/node_cli.py', '_host_delegated_command', 1, 14, 14).
python_function('adapters/python/urirun/node/node_cli.py', 'fulfill_need', 3, 4, 5).
python_function('adapters/python/urirun/node/node_cli.py', 'supply_command', 1, 8, 12).
python_function('adapters/python/urirun/node/node_cli.py', 'ensure_command', 1, 5, 8).
python_function('adapters/python/urirun/node/node_cli.py', '_maybe_ensure_scheme', 4, 4, 4).
python_function('adapters/python/urirun/node/node_cli.py', '_run_streamed', 5, 6, 18).
python_function('adapters/python/urirun/node/node_cli.py', 'run_command', 1, 8, 13).
python_function('adapters/python/urirun/node/node_cli.py', '_print_event', 2, 6, 4).
python_function('adapters/python/urirun/node/node_cli.py', 'watch_command', 1, 11, 16).
python_function('adapters/python/urirun/node/node_cli.py', '_watch_loop', 1, 7, 5).
python_function('adapters/python/urirun/node/node_cli.py', '_host_cmd_config', 3, 1, 1).
python_function('adapters/python/urirun/node/node_cli.py', '_host_cmd_nodes', 3, 2, 3).
python_function('adapters/python/urirun/node/node_cli.py', '_host_cmd_routes', 3, 2, 3).
python_function('adapters/python/urirun/node/node_cli.py', '_host_cmd_agents', 3, 5, 2).
python_function('adapters/python/urirun/node/node_cli.py', '_host_cmd_doctor', 3, 5, 6).
python_function('adapters/python/urirun/node/node_cli.py', '_host_cmd_ask', 3, 5, 10).
python_function('adapters/python/urirun/node/node_cli.py', '_host_mesh_command', 3, 5, 7).
python_function('adapters/python/urirun/node/node_cli.py', 'copy_id_command', 1, 12, 12).
python_function('adapters/python/urirun/node/node_cli.py', 'copy_id_cli', 1, 7, 7).
python_function('adapters/python/urirun/node/node_cli.py', '_split_deploy_doc', 1, 4, 3).
python_function('adapters/python/urirun/node/node_cli.py', '_warn_dropped_routes', 1, 3, 4).
python_function('adapters/python/urirun/node/node_cli.py', 'deploy_command', 1, 15, 15).
python_function('adapters/python/urirun/node/node_cli.py', '_maybe_load_dotenv', 1, 11, 9).
python_function('adapters/python/urirun/node/node_cli.py', 'host_command', 1, 3, 6).
python_function('adapters/python/urirun/node/node_cli.py', '_probe_one_route', 5, 13, 10).
python_function('adapters/python/urirun/node/node_cli.py', '_render_probe_report', 1, 10, 4).
python_function('adapters/python/urirun/node/node_cli.py', 'probe_command', 1, 14, 11).
python_function('adapters/python/urirun/node/node_cli.py', 'node_list_command', 1, 7, 7).
python_function('adapters/python/urirun/node/node_cli.py', 'node_stop_command', 1, 14, 9).
python_function('adapters/python/urirun/node/node_cli.py', '_resolve_registry_source', 2, 6, 4).
python_function('adapters/python/urirun/node/node_cli.py', 'node_command', 1, 11, 14).
...
python_function('adapters/python/urirun/node/recovery.py', '_uri_remediate', 1, 4, 5).
...
python_function('adapters/python/urirun/node/reversible.py', 'planner_context', 4, 6, 7).
...
python_function('adapters/python/urirun/node/reversible.py', '_transition_inverse_uri', 1, 3, 2).
python_function('adapters/python/urirun/node/reversible.py', '_normalize_stuck', 1, 8, 5).
python_function('adapters/python/urirun/node/reversible.py', '_uri_rollback', 1, 15, 11).
...
python_function('adapters/python/urirun/node/server.py', '_registry_to_bindings', 1, 7, 6).
python_function('adapters/python/urirun/node/server.py', '_deploy_registry', 2, 9, 4).
...
python_function('adapters/python/urirun/node/task_cli.py', '_run_task_flow', 2, 12, 17).
...
python_function('adapters/python/urirun/runtime/v2_service.py', 'make_dispatch', 3, 1, 3).
...
python_class('adapters/python/tests/test_proof_cache.py', '_DurableEnv').
python_method('_DurableEnv', 'setUp', 0, 1, 3).
python_method('_DurableEnv', 'tearDown', 0, 2, 2).
python_class('adapters/python/tests/test_proof_cache.py', 'TestProofDurable').
python_method('TestProofDurable', 'test_proofs_namespace_persists_across_handles', 0, 1, 8).
python_class('adapters/python/tests/test_proof_cache.py', 'TestProofCheckRecord').
python_method('TestProofCheckRecord', '_pay', 0, 1, 0).
python_method('TestProofCheckRecord', 'test_check_miss_then_record_then_hit', 0, 1, 6).
python_method('TestProofCheckRecord', 'test_record_negative_is_no_op', 0, 1, 4).
python_method('TestProofCheckRecord', 'test_route_key_matches_episode_proof_key', 0, 1, 5).
python_class('adapters/python/tests/test_proof_cache.py', 'TestProofGate').
python_method('TestProofGate', '_pay', 0, 1, 0).
python_method('TestProofGate', 'test_new_env_probes_and_records', 0, 1, 9).
python_method('TestProofGate', 'test_same_context_hits_and_skips_sandbox', 0, 1, 7).
python_method('TestProofGate', 'test_drift_invalidates_and_reprobes', 0, 1, 6).
python_method('TestProofGate', 'test_irreversible_blocks_and_caches_nothing', 0, 1, 8).
...
python_class('adapters/python/urirun/node/episode.py', 'EpisodeReality').
python_class('adapters/python/urirun/node/episode.py', 'EpisodePlan').
python_class('adapters/python/urirun/node/episode.py', 'EpisodeProof').
python_class('adapters/python/urirun/node/episode.py', 'EpisodeArtifact').
python_class('adapters/python/urirun/node/episode.py', 'EpisodeOutcome').
python_class('adapters/python/urirun/node/episode.py', 'Episode').
python_method('Episode', 'to_dict', 0, 1, 1).
python_method('Episode', 'from_dict', 1, 13, 7).
python_class('adapters/python/urirun/node/event_schema.py', '_StepTransition').
...
python_method('TwinMemory', 'recall_episode', 2, 7, 2).
...
python_method('NodeHandler', '_handle_run', 0, 14, 22).
...
*453 nodes · 500 edges · 44 modules · CC̄=4.8*
...
| `scanner_best_finish` *(in adapters.python.urirun.host.scanner_bridge)* | 14 ⚠ | 0 | 48 | **48** |
| `frame_visual_metrics` *(in adapters.python.urirun.host.scanner_bridge)* | 7 | 1 | 40 | **41** |
| `scanner_capture` *(in adapters.python.urirun.host.scanner_bridge)* | 13 ⚠ | 0 | 40 | **40** |
| `_write_planfile_action` *(in adapters.python.urirun.host.host_integrations)* | 8 | 1 | 39 | **40** |
| `scanner_crop_overlay` *(in adapters.python.urirun.host.scanner_bridge)* | 8 | 2 | 33 | **35** |
| `restart_phone_scanner_service` *(in adapters.python.urirun.host.scanner_service)* | 15 ⚠ | 0 | 33 | **33** |
...
# generated in 0.24s
# nodes: 453 | edges: 500 | modules: 44
# CC̄=4.8
...
MODULES:
  ...
  adapters.python.urirun.host.artifacts_admin  [1 funcs]
    preview_url  CC=8  out:21
  ...
  adapters.python.urirun.host.discovery  [23 funcs]
    ...
    iter_node_alias_values  CC=9  out:13
    known_nodes_file_data  CC=3  out:5
    known_nodes_file_urls  CC=1  out:2
  ...
  adapters.python.urirun.host.document_sync  [50 funcs]
  ...
  adapters.python.urirun.host.object_registry  [53 funcs]
  ...
  adapters.python.urirun.host.scanner_bridge  [51 funcs]
    _add_log  CC=3  out:1
    best_candidate_paths  CC=3  out:10
    best_crop_and_ocr  CC=3  out:6
    best_finish_store_failure  CC=5  out:4
    best_quality_rejected  CC=5  out:7
    bounded  CC=1  out:2
    capture_candidate_result  CC=4  out:12
    capture_display_path  CC=3  out:3
  ...
  adapters.python.urirun.host.scanner_service  [5 funcs]
    ensure_phone_scanner_service  CC=10  out:21
    phone_node_qr  CC=9  out:26
    phone_scanner_service_id  CC=1  out:0
    restart_phone_scanner_service  CC=15  out:33
    startup_phone_qr  CC=10  out:24
