...
# urirun | 281f 62732L | python:259,shell:10,javascript:4,go:3,rust:2,typescript:2,less:1 | 2026-06-26
# stats: 2699 func | 146 cls | 281 mod | CC̄=4.3 | critical:242 | cycles:0
# alerts[5]: CC test_dashboard_html_tracks_tabs_actions_and_chat_fullscreen=125; CC test_archive_scanned_document_writes_pdf_json_index_and_detects_duplicate=26; CC test_sync_documents_to_node_copies_pdfs_and_logs_chat=23; CC test_chat_ask_plans_document_sync_without_llm=22; CC _chat_ask_general=21
...
M[281]:
  ...
  adapters/python/tests/test_dashboard_api_characterizing.py,210
  ...
  adapters/python/tests/test_episode_capture.py,109
  ...
  adapters/python/tests/test_flow_twin.py,464
  ...
  adapters/python/tests/test_runtime_extractable.py,77
  ...
  adapters/python/urirun/host/chat_orchestrator.py,896
  ...
  adapters/python/urirun/host/dispatch.py,67
  ...
  adapters/python/urirun/host/host_dashboard.py,1823
  ...
  adapters/python/urirun/host/scanner_bridge.py,2
  adapters/python/urirun/host/scanner_net.py,14
  adapters/python/urirun/host/scanner_service.py,7
  ...
  adapters/python/urirun/host/twin_bridge.py,450
  ...
  adapters/python/urirun/node/flow.py,1067
  adapters/python/urirun/node/flow_planner.py,696
  adapters/python/urirun/node/flow_thin.py,489
  ...
  adapters/python/urirun/runtime/_runtime.py,594
  ...
  adapters/python/urirun/runtime/v2.py,1997
  ...
  adapters/python/urirun/runtime/v2_service.py,146
  adapters/python/urirun/runtime/worker.py,290
  ...
  scripts/extraction_audit.py,337
...
D:
  ...
  adapters/python/urirun/host/dashboard_http.py:
    e: _json_response,_html_response,_asset_response,_js_sdk_response,_read_json,_file_response
  ...
  adapters/python/urirun/host/twin_bridge.py:
    e: flow_has_desktop_step,_step_inverse,_is_infra_step,_step_info_from_results,_inverse_from_results,_step_status,_step_narration,_publish_step_event,_episode_proofs,_episode_artifacts,_coerce_next_intent,capture_episode,append_twin_widget,twin_plan_preview,twin_plan_summary,is_desktop_task_prompt,api_twin_state
  ...
  adapters/python/urirun/node/flow.py:
    e: _flow_format,flow_document,write_flow_document,load_flow_document,_flow_step_failure,_flow_timeline_entry,_evaluate_step_next,_run_step,_self_heal_via_uri,_attempt_self_heal,_preflight,_rollback_partial,_kvm_targets,suggest_recall,_flow_key,_remember_known_good_flow,_capture_known_good,_update_known_good,_drift_timeline,_circuit_break_if_over,_resolve_payload_or_fail,_step_fail_envelope,_abort_envelope,_set_service_map,_restore_service_map,_orchestrate_steps,_make_memory_dispatch,_plan_with_preflight,_build_thin_plan,execute_flow,_apply_reversibility,run_flow_document,_in_process_discovery,make_dispatch_uri,_flow_transport,rollback_flow,_uri_goal_verify,_uri_preflight,_uri_env_drift,_uri_memory_remember
  ...
  adapters/python/urirun/node/flow_planner.py:
    e: first_url,nl_key,append_if_available,requested_folder_path,_flow_intents_llm,_flow_intents,_append_target_steps,heuristic_flow,json_from_text,_uri_segments,_uri_matches_template,_uri_is_available,_infeasibility_error,_step_is_infeasible,_normalize_flow_step,_normalize_flow_task,_needs_session_ready_after_ensure,_inject_cdp_ready_probes,_collect_infeasible_constraints,normalize_flow,normalize_flow_or_explain,llm_flow,_build_session_map,_append_session_guidance,_fetch_kvm_query,_fetch_env_profile,_fetch_surface,fetch_planner_environments,make_flow
    first_url(prompt)
    nl_key(text)
  ...
  adapters/python/urirun/node/reversible.py:
    ...
    TwinMemory: remember(2),known_good(1),drift(2),remember_flow(2),recall_flow(1),known_good_flows(0),degraded_flows(0),remember_episode(1),known_good_episodes(0),recall_episode(2),remember_proof(2),recall_proof(1)  # Remembers the KNOWN-GOOD environment fingerprint per node (s
    parse(uri)
    path_of(uri)
    sig(obj)
    _step_kind(spec)
...
% ── Project Metadata ─────────────────────────────────────
project_metadata('urirun', '0.4.169', 'javascript').
...
project_file('adapters/python/tests/test_dashboard_api_characterizing.py', 210, 'python').
...
project_file('adapters/python/tests/test_episode_capture.py', 109, 'python').
...
project_file('adapters/python/tests/test_flow_twin.py', 464, 'python').
...
project_file('adapters/python/tests/test_runtime_extractable.py', 77, 'python').
...
project_file('adapters/python/urirun/host/chat_orchestrator.py', 896, 'python').
...
project_file('adapters/python/urirun/host/dispatch.py', 67, 'python').
...
project_file('adapters/python/urirun/host/twin_bridge.py', 450, 'python').
...
project_file('adapters/python/urirun/node/flow.py', 1067, 'python').
project_file('adapters/python/urirun/node/flow_planner.py', 696, 'python').
project_file('adapters/python/urirun/node/flow_thin.py', 489, 'python').
...
project_file('adapters/python/urirun/node/node_cli.py', 900, 'python').
...
project_file('adapters/python/urirun/node/reversible.py', 668, 'python').
...
project_file('adapters/python/urirun/node/task_cli.py', 347, 'python').
project_file('adapters/python/urirun/node/transport.py', 541, 'python').
project_file('adapters/python/urirun/node/twin_store.py', 125, 'python').
...
project_file('adapters/python/urirun/runtime/_runtime.py', 594, 'python').
...
project_file('adapters/python/urirun/runtime/cli.py', 717, 'python').
...
project_file('adapters/python/urirun/runtime/daemon.py', 116, 'python').
...
project_file('adapters/python/urirun/runtime/errors.py', 576, 'python').
...
project_file('adapters/python/urirun/runtime/v2.py', 1997, 'python').
...
project_file('adapters/python/urirun/runtime/v2_service.py', 146, 'python').
project_file('adapters/python/urirun/runtime/worker.py', 290, 'python').
...
project_file('scripts/extraction_audit.py', 337, 'python').
...
python_function('adapters/python/tests/test_dashboard_api_characterizing.py', 'test_api_twin_state_shape', 1, 11, 4).
...
python_function('adapters/python/urirun/host/chat_orchestrator.py', '_general_path_complete', 10, 16, 8).
...
python_function('adapters/python/urirun/host/chat_orchestrator.py', '_chat_ask_general', 13, 21, 22).
...
python_function('adapters/python/urirun/host/dispatch.py', 'inprocess_fallback', 2, 16, 11).
...
python_function('adapters/python/urirun/host/domain_monitor.py', 'set_ticket_creator', 1, 1, 0).
python_function('adapters/python/urirun/host/domain_monitor.py', 'create_dns_repair_ticket', 0, 3, 3).
...
python_function('adapters/python/urirun/host/twin_bridge.py', 'api_twin_state', 5, 18, 16).
...
python_function('adapters/python/urirun/node/flow.py', '_remember_known_good_flow', 5, 9, 8).
...
python_function('adapters/python/urirun/node/flow.py', '_make_memory_dispatch', 4, 1, 15).
...
python_function('adapters/python/urirun/node/flow.py', '_in_process_discovery', 2, 17, 10).
...
python_function('adapters/python/urirun/node/flow.py', '_uri_memory_remember', 1, 13, 11).
python_function('adapters/python/urirun/node/flow_planner.py', 'first_url', 1, 2, 2).
python_function('adapters/python/urirun/node/flow_planner.py', 'nl_key', 1, 1, 6).
python_function('adapters/python/urirun/node/flow_planner.py', 'append_if_available', 5, 5, 5).
python_function('adapters/python/urirun/node/flow_planner.py', 'requested_folder_path', 1, 3, 2).
python_function('adapters/python/urirun/node/flow_planner.py', '_flow_intents_llm', 1, 6, 7).
python_function('adapters/python/urirun/node/flow_planner.py', '_flow_intents', 1, 6, 3).
python_function('adapters/python/urirun/node/flow_planner.py', '_append_target_steps', 6, 14, 4).
python_function('adapters/python/urirun/node/flow_planner.py', 'heuristic_flow', 4, 13, 15).
python_function('adapters/python/urirun/node/flow_planner.py', 'json_from_text', 1, 5, 7).
python_function('adapters/python/urirun/node/flow_planner.py', '_uri_segments', 1, 1, 3).
python_function('adapters/python/urirun/node/flow_planner.py', '_uri_matches_template', 2, 6, 6).
python_function('adapters/python/urirun/node/flow_planner.py', '_uri_is_available', 2, 4, 2).
python_function('adapters/python/urirun/node/flow_planner.py', '_infeasibility_error', 2, 1, 0).
python_function('adapters/python/urirun/node/flow_planner.py', '_step_is_infeasible', 2, 6, 1).
python_function('adapters/python/urirun/node/flow_planner.py', '_normalize_flow_step', 6, 15, 11).
python_function('adapters/python/urirun/node/flow_planner.py', '_normalize_flow_task', 1, 5, 3).
python_function('adapters/python/urirun/node/flow_planner.py', '_needs_session_ready_after_ensure', 2, 5, 2).
python_function('adapters/python/urirun/node/flow_planner.py', '_inject_cdp_ready_probes', 4, 10, 11).
python_function('adapters/python/urirun/node/flow_planner.py', '_collect_infeasible_constraints', 1, 6, 2).
python_function('adapters/python/urirun/node/flow_planner.py', 'normalize_flow', 4, 5, 8).
python_function('adapters/python/urirun/node/flow_planner.py', 'normalize_flow_or_explain', 2, 11, 8).
python_function('adapters/python/urirun/node/flow_planner.py', 'llm_flow', 4, 8, 7).
python_function('adapters/python/urirun/node/flow_planner.py', '_build_session_map', 1, 6, 2).
python_function('adapters/python/urirun/node/flow_planner.py', '_append_session_guidance', 2, 7, 3).
python_function('adapters/python/urirun/node/flow_planner.py', '_fetch_kvm_query', 4, 6, 6).
python_function('adapters/python/urirun/node/flow_planner.py', '_fetch_env_profile', 2, 1, 1).
...
python_function('adapters/python/urirun/node/flow_thin.py', '_thin_goal_verify', 4, 11, 6).
python_function('adapters/python/urirun/node/flow_thin.py', '_results_degraded', 1, 9, 4).
python_function('adapters/python/urirun/node/flow_thin.py', '_capture_proofs_from_results', 1, 16, 4).
python_function('adapters/python/urirun/node/flow_thin.py', '_enrich_remember_with_degraded', 3, 8, 6).
python_function('adapters/python/urirun/node/flow_thin.py', '_thin_driver', 5, 17, 17).
...
python_function('adapters/python/urirun/node/flow_verify.py', '_goal_passed', 3, 8, 2).
python_function('adapters/python/urirun/node/flow_verify.py', '_verify_log_fragment_check', 3, 6, 3).
python_function('adapters/python/urirun/node/flow_verify.py', '_verify_goal_check', 3, 5, 3).
python_function('adapters/python/urirun/node/flow_verify.py', 'verify_flow_execution', 2, 10, 6).
...
python_function('adapters/python/urirun/runtime/_runtime.py', 'run', 7, 16, 14).
...
python_function('adapters/python/urirun/runtime/errors.py', 'register_ticket_creator', 1, 1, 0).
python_function('adapters/python/urirun/runtime/errors.py', 'to_ticket', 3, 8, 4).
...
python_function('adapters/python/urirun/runtime/v2.py', 'register_executor', 2, 1, 0).
...
python_function('adapters/python/urirun/runtime/v2.py', '_run_execute', 6, 11, 6).
...
python_function('adapters/python/urirun/runtime/worker.py', '_pool_executors', 1, 1, 5).
...
python_function('scripts/extraction_audit.py', 'resolve_package', 2, 6, 3).
python_function('scripts/extraction_audit.py', 'classify', 5, 10, 5).
python_function('scripts/extraction_audit.py', 'audit', 2, 6, 11).
...
python_class('adapters/python/urirun/runtime/v2.py', '_ExecutorProxy').
...
*426 nodes · 500 edges · 44 modules · CC̄=4.7*
...
| `_handle_post` *(in adapters.python.urirun.host.host_dashboard)* | 13 ⚠ | 1 | 27 | **28** |
| `_read_json` *(in adapters.python.urirun.host.dashboard_http)* | 3 | 23 | 5 | **28** |

```toon markpact:analysis path=project/calls.toon.yaml
# code2llm call graph | /home/tom/github/if-uri/urirun
# generated in 0.22s
# nodes: 426 | edges: 500 | modules: 44
# CC̄=4.7
...
HUBS[20]:
  ...
  adapters.python.urirun.host.host_dashboard._handle_post_nodes
