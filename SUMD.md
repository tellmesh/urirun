...
# urirun | 197f 51482L | python:175,shell:10,javascript:4,go:3,rust:2,typescript:2,less:1 | 2026-06-25
# stats: 1963 func | 93 cls | 197 mod | CC̄=4.8 | critical:238 | cycles:0
# alerts[5]: CC test_dashboard_html_tracks_tabs_actions_and_chat_fullscreen=125; CC test_archive_scanned_document_writes_pdf_json_index_and_detects_duplicate=26; CC test_sync_documents_to_node_copies_pdfs_and_logs_chat=23; CC test_chat_ask_plans_document_sync_without_llm=22; CC _chat_ask_general=15
...
M[197]:
  ...
  adapters/python/tests/test_reversible.py,342
  ...
  adapters/python/urirun/connectors/connector_lint.py,603
  ...
  adapters/python/urirun/host/contracts.py,65
  ...
  adapters/python/urirun/host/host_dashboard.py,11509
  ...
  adapters/python/urirun/host/scanner_bridge.py,671
  adapters/python/urirun/host/scanner_net.py,141
  adapters/python/urirun/host/scheduler.py,136
  adapters/python/urirun/host/service_control.py,377
  adapters/python/urirun/host/task_planner.py,375
  ...
  adapters/python/urirun/node/flow.py,971
  ...
  adapters/python/urirun/node/mesh.py,1980
  adapters/python/urirun/node/paths.py,39
  adapters/python/urirun/node/recovery.py,300
  adapters/python/urirun/node/reversible.py,380
  ...
  adapters/python/urirun/runtime/cli.py,711
  ...
  tests/test_node_flow_recovery.py,110
...
D:
  ...
  adapters/python/tests/test_refactor_helpers.py:
    ...
    DashboardApiRoutingTests: test_unknown_path_is_404(0),test_route_table_covers_expected_endpoints(0)  # _dashboard_api_response was converted from an if-chain to a 
  ...
  adapters/python/tests/test_reversible.py:
    e: KvmFake,DataFake,ReversibleEngineTests,FlowBridgeTests,TwinMemoryTests,NodelessInverseRebaseTests,PlannerContextTests
    ...
    PlannerContextTests: test_cdp_env_guides_to_dom(0),test_uncontrollable_env_refuses_ui(0),test_foreground_url_demands_real_labels(0),test_drift_warns_to_remeasure(0)  # profile->planner: concrete env facts so the LLM grounds on r
  ...
  adapters/python/urirun/host/contracts.py:
    e: verification_check,file_transfer_verification
  ...
  adapters/python/urirun/host/document_sync.py:
    e: boolish,document_archive_pdfs,document_sync_verification,_log_and_chat_report,_resolve_node_params,_parse_sync_params,_build_sync_params,_check_preflight,_upload_file,_read_back_file,sync_documents_to_node,DocumentSyncDeps,_SyncParams
    DocumentSyncDeps:
    _SyncParams:
  ...
  adapters/python/urirun/host/host_dashboard.py:
    ...
    _crop_dimensions(crop)
    _crop_geometry_score(crop;reasons)
    ...
    _scanner_result_content(content_prefix;crop;document;ocr)
    _register_scanner_result(project;db)
    _orientation_summary(crop)
    _decode_capture_image(raw_image)
    _capture_quality_ok(payload;quality;min_score)
    _capture_reject_result()
    _capture_candidate_result(project;payload)
    _capture_display_path(crop;path)
    _capture_ocr_and_detect(path;display_path;payload;archive)
    scanner_capture(project;db;payload)
    _best_series_not_found(series_id)
    _resolve_best_candidate(series)
    _best_quality_rejected(payload;quality)
    _best_candidate_paths(best)
    _best_finish_store_failure(series_id;series)
  ...
  adapters/python/urirun/host/service_control.py:
    e: payload_truthy,service_restart_argv,schedule_restart_command,_resolve_chat_service_script,_append_chat_restart_options,chat_service_restart_argv,restart_chat_service,port_holder_pids,process_cmdline,_cmdline_contains,is_dashboard_process,is_scanner_process,is_chat_process,is_android_node_process,_signal_pids,free_port_from_matching_processes,_free_port_result,free_port_from_old_dashboard
  ...
  adapters/python/urirun/node/recovery.py:
    e: _infer_category,normalize_error,exception_error,step_target,route_for_step,_llm_model_actions,_transient_actions,_not_found_actions,_fallback_actions,recovery_actions,failure_signature,recovery_plan,apply_auto_remediation,can_retry_step,planner_failure
    _infer_category(out)
  ...
  adapters/python/urirun/node/reversible.py:
    e: parse,path_of,sig,_step_kind,environment_fingerprint,plausibility,planner_context,local_transport,rollback_partial_flow,_inner_value,_inverse_uri,ledger_from_execution,CallSpec,Action,Transition,Transport,CallableTransport,Connector,Twin,ReversibleProcess,TwinMemory
...
% ── Project Metadata ─────────────────────────────────────
project_metadata('urirun', '0.4.146', 'javascript').
...
project_file('adapters/python/tests/test_reversible.py', 342, 'python').
...
project_file('adapters/python/urirun/host/contracts.py', 65, 'python').
...
project_file('adapters/python/urirun/host/host_dashboard.py', 11509, 'python').
...
project_file('adapters/python/urirun/host/service_control.py', 377, 'python').
...
project_file('adapters/python/urirun/node/flow.py', 971, 'python').
...
project_file('adapters/python/urirun/node/mesh.py', 1980, 'python').
...
project_file('adapters/python/urirun/node/reversible.py', 387, 'python').
...
project_file('adapters/python/urirun/runtime/cli.py', 711, 'python').
...
python_function('adapters/python/urirun/host/host_dashboard.py', '_scanner_stream_summary', 3, 1, 1).
...
python_function('adapters/python/urirun/host/host_dashboard.py', '_crop_dimensions', 1, 5, 2).
python_function('adapters/python/urirun/host/host_dashboard.py', '_crop_geometry_score', 2, 8, 7).
python_function('adapters/python/urirun/host/host_dashboard.py', '_crop_quality_score', 2, 6, 6).
...
python_function('adapters/python/urirun/host/host_dashboard.py', '_public_scanner_candidate', 1, 1, 1).
...
python_function('adapters/python/urirun/host/host_dashboard.py', '_scanner_status_from_log', 1, 1, 1).
python_function('adapters/python/urirun/host/host_dashboard.py', '_latest_scanner_page_status', 1, 2, 3).
python_function('adapters/python/urirun/host/host_dashboard.py', '_scanner_artifact_doc_meta', 1, 1, 1).
python_function('adapters/python/urirun/host/host_dashboard.py', '_is_scanner_artifact', 3, 1, 1).
python_function('adapters/python/urirun/host/host_dashboard.py', '_scanner_artifact_item', 7, 1, 1).
...
python_function('adapters/python/urirun/host/host_dashboard.py', '_capture_display_path', 2, 3, 2).
...
python_function('adapters/python/urirun/host/host_dashboard.py', '_best_quality_rejected', 2, 5, 2).
...
python_function('adapters/python/urirun/host/host_dashboard.py', '_configured_api_call', 3, 9, 10).
...
python_function('adapters/python/urirun/host/host_dashboard.py', '_general_path_complete', 9, 11, 6).
python_function('adapters/python/urirun/host/host_dashboard.py', '_chat_ask_general', 12, 15, 21).
...
python_function('adapters/python/urirun/host/host_dashboard.py', 'create_handler', 6, 1, 56).
...
python_function('adapters/python/urirun/node/flow.py', 'fetch_planner_environments', 3, 8, 6).
...
python_function('adapters/python/urirun/node/flow.py', 'execute_flow', 4, 13, 11).
...
python_function('adapters/python/urirun/node/mesh.py', '_write_pushed_code', 2, 10, 14).
...
python_function('adapters/python/urirun/node/mesh.py', '_reimport_pushed_code', 2, 3, 4).
python_function('adapters/python/urirun/node/mesh.py', '_apply_deploy_surface', 2, 9, 3).
python_function('adapters/python/urirun/node/mesh.py', '_apply_deploy_allow', 3, 6, 4).
python_function('adapters/python/urirun/node/mesh.py', 'apply_deploy', 2, 12, 15).
python_function('adapters/python/urirun/node/mesh.py', '_parse_sse_query', 1, 3, 3).
python_function('adapters/python/urirun/node/mesh.py', '_sse_initial_cursor', 3, 4, 3).
...
python_function('adapters/python/urirun/node/mesh.py', '_resolve_serve_opts', 2, 7, 9).
...
python_function('adapters/python/urirun/node/reversible.py', 'planner_context', 4, 13, 4).
...
python_function('adapters/python/urirun/node/transport.py', 'discover_node', 1, 8, 8).
...
*425 nodes · 500 edges · 43 modules · CC̄=4.6*
...
# generated in 0.23s
# nodes: 425 | edges: 500 | modules: 43
# CC̄=4.6
...
MODULES:
  ...
  adapters.python.urirun.host.scanner_bridge  [18 funcs]
    _add_log  CC=3  out:1
    is_autonomous_scanner_prompt  CC=6  out:4
    is_camera_start_prompt  CC=4  out:3
    is_phone_scanner_prompt  CC=11  out:6
    latest_scanner_page_status  CC=7  out:8
    nl_text  CC=3  out:6
    page_action_enqueue  CC=4  out:10
    page_action_result  CC=3  out:9
    public_scanner_candidate  CC=4  out:15
    register_document_artifact  CC=7  out:15
  ...
  adapters.python.urirun.runtime.v2  [25 funcs]
    ...
    _placeholder_kwargs  CC=2  out:1
    _select_entry_points  CC=5  out:6
    build_binding_document  CC=3  out:5
