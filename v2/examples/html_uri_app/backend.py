...
from urirun.v2 import compile_registry, expand_bindings, run as run_uri, validate_binding_document  # noqa: E402
from urirun.v2_mcp import call_tool, to_a2a_card, to_mcp_manifest  # noqa: E402
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self) -> None:
        ...
        if parsed.path == "/api/health":
            json_response(self, 200, {"ok": True, "service": "html-uri-app-v2"})
            return
...
def main() -> int:
    ...
    print(f"Serving urirun v2 HTML app at http://{host}:{selected_port}/", flush=True)
